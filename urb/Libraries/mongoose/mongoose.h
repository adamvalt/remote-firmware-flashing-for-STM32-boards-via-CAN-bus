...
#define MG_FILESAVE_FLASH_NONE 0        // No filesave to flash support
#define MG_FILESAVE_FLASH_STM32H7 2     // STM32 H7

#ifndef MG_FILESAVE_FLASH
#define MG_FILESAVE_FLASH MG_FILESAVE_FLASH_NONE
#endif

#if MG_FILESAVE_FLASH != MG_FILESAVE_FLASH_NONE
#ifndef MG_FILESAVE_FLASH_ADDRESS
#error "MG_FILESAVE_FLASH_ADDRESS has to be defined when MG_FILESAVE_FLASH is not MG_FILESAVE_FLASH_NONE"
#endif
#ifndef MG_FILESAVE_FLASH_SIZE
#error "MG_FILESAVE_FLASH_SIZE has to be defined when MG_FILESAVE_FLASH is not MG_FILESAVE_FLASH_NONE"
#endif
#endif

#if (MG_OTA != MG_OTA_NONE || MG_OTA == MG_OTA_CUSTOM) && MG_FILESAVE_FLASH == MG_FILESAVE_FLASH_NONE
#error "Device OTA and File saving to flash not supported at the same time"
#endif
...
// Save file to flash API
bool mg_save_file_begin(size_t new_firmware_size);    // Start writing
bool mg_save_file_write(const void *buf, size_t len); // Write chunk, aligned to memory
bool mg_save_file_end(void);                          // Stop writing

// Expose almost raw flash write api to use in certain circumstances
// warning no crc, almost no error checking
