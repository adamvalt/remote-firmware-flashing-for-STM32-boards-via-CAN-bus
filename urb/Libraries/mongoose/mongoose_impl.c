...
struct attribute s_flashing_attributes[] = {
        {"selected_board", "string", NULL, offsetof(struct flashing, selected_board), 100, false},
        {"new_version", "string", NULL, offsetof(struct flashing, new_version), 40, false},
        {"filename", "string", NULL, offsetof(struct flashing, filename), 100, false},
        {"error", "string", NULL, offsetof(struct flashing, error), 100, false},
        {"is_active", "bool", NULL, offsetof(struct flashing, is_active), 0, false},
        {"size", "int", NULL, offsetof(struct flashing, size), 0, false},
        {"progress", "int", NULL, offsetof(struct flashing, progress), 0, false},
        {"state", "int", NULL, offsetof(struct flashing, state), 0, false},
        {"crc", "int", NULL, offsetof(struct flashing, crc), 0, false},
        {NULL, NULL, NULL, 0, 0, false}
};

struct apihandler_upload s_apihandler_file_upload = {{"file_upload", "upload", false, 3, 3, 0UL}, glue_file_open_file_upload, glue_file_close_file_upload, glue_file_write_file_upload};
...
struct apihandler_custom s_apihandler_boards = {{"boards", "custom", false, 0, 0, 0UL}, glue_reply_boards};
struct apihandler_action s_apihandler_reboot = {{"reboot", "action", false, 3, 3, 0UL}, glue_check_reboot, glue_start_reboot};
struct apihandler_action s_apihandler_flashing_action = {{"flashing_action", "action", false, 3, 3, 0UL}, glue_check_flashing_action, glue_start_flashing_action};
struct apihandler_custom s_apihandler_flashing_history = {{"flashing_history", "custom", false, 0, 0, 0UL}, glue_reply_flashing_history};
struct apihandler_data s_apihandler_flashing = {{"flashing", "data", false, 3, 3, 0UL}, s_flashing_attributes, sizeof(struct flashing), (void (*)(void *)) glue_get_flashing, (void (*)(void *)) glue_set_flashing};
...
static struct apihandler *s_apihandlers[] = {
        ...
        (struct apihandler *) &s_apihandler_boards,
        (struct apihandler *) &s_apihandler_reboot,
        (struct apihandler *) &s_apihandler_flashing_action,
        (struct apihandler *) &s_apihandler_flashing_history,
        (struct apihandler *) &s_apihandler_flashing
};
