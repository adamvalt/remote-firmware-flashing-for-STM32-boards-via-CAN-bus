...
#define MG_FILESAVE_FLASH MG_FILESAVE_FLASH_STM32H7

// defines the part of the flash which is intended for the firmware file storage
#define MG_FILESAVE_FLASH_ADDRESS 0x08060000 // 4rd sector onwards
#define MG_FILESAVE_FLASH_SIZE 0xA0000
