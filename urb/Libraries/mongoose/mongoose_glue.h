...
void glue_reply_boards(struct mg_connection *, struct mg_http_message *);
...
void glue_get_flashing(struct flashing *);
void glue_set_flashing(struct flashing *);

void glue_start_flashing_action(struct mg_str);  // Start an action
bool glue_check_flashing_action(void);  // Check if action is still in progress

void glue_reply_flashing_history(struct mg_connection *, struct mg_http_message *);
